...
echo Running preremove qgis-dev.bat...
%COMSPEC% /c etc\preremove\qgis-dev.bat>>preremove.log 2>&1
ren etc\preremove\qgis-dev.bat qgis-dev.bat.done>>preremove.log 2>&1
