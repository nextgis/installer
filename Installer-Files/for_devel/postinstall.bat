...
echo Running postinstall qgis-dev.bat...
%COMSPEC% /c etc\postinstall\qgis-dev.bat>>postinstall.log 2>&1
ren etc\postinstall\qgis-dev.bat qgis-dev.bat.done>>postinstall.log 2>&1
