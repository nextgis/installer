...
<qgis version="2.6.1-Brighton" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{7699a583-d039-4659-8cad-e95626f2372c}">
      <rule filter="&quot;natural&quot; = 'water' or &quot;other_tags&quot; LIKE '%&quot;water&quot;%' or &quot;other_tags&quot; LIKE '%&quot;waterway&quot;=>&quot;riverbank&quot;%'" key="{928d28b7-10a1-4dee-9938-2ccb7e808fa0}" symbol="0" label="water"/>
      <rule filter="&quot;landuse&quot; = 'forest' or &quot;leisure&quot; = 'park'" key="{0d43bd0b-9d2e-4953-8c52-40a7e0d60808}" symbol="1" label="forest &amp; park"/>
      <rule filter=" &quot;aeroway&quot; is not null or &quot;landuse&quot; = 'industrial'" key="{5ed44ac0-a03e-487b-a0a0-379c787341a3}" symbol="2" label="industrial"/>
      <rule filter="&quot;landuse&quot; = 'residential'" key="{85c2a97a-c075-4a7a-a8e6-4345ee87dada}" symbol="3" label="residential"/>
      <rule scalemaxdenom="15000" filter=" &quot;building&quot; is not null" key="{56252d54-749c-446b-968f-e495ed0f3f7f}" symbol="4" scalemindenom="1" label="building">
        <rule filter="&quot;building&quot; IN ( 'church','cathedral')" key="{36eb40fb-1ccc-48ef-9618-3183727849c5}" symbol="5" label="church"/>
      </rule>
    </rules>
    <symbols>
