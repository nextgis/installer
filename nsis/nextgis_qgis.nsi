...
!ifndef SMPROGRAMS_FOLDER_NAME_EN
    !define SMPROGRAMS_FOLDER_NAME_RU "${PROGRAM_NAME}"
!endif
!ifndef SMPROGRAMS_FOLDER_NAME_RU
...
!ifndef NextGIS_QGIS_RUN_LNK_ICO_FileName
    ...
    !define NextGIS_QGIS_RUN_LNK_ICO_Path "${QGIS_SRC_DIR}\icons\${NextGIS_QGIS_RUN_LNK_ICO_FileName}"
!endif
